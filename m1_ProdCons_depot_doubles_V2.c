/*
 * Producteur-consommateur, un producteur depose deux messages sonsecutifs
 * VERSION 2 -Marche si on specifie qu'un seul thread pour chaque Producteaur pour l'execution (nbFoisProd=1)  !IMPORTANT!
 *
